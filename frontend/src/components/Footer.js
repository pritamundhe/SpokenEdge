            ...
            <div className="max-w-7xl mx-auto px-6 py-12 lg:px-8">
                    ...
                    <div className="space-y-4">
                        <Link href="/" className="flex items-center gap-2 group mb-4">
                            <div className="text-2xl font-bold font-sans tracking-tighter flex items-center">
                                ...
                                <div className="w-1.5 h-1.5 rounded-full bg-primary ml-0.5"></div>
                            </div>
                        </Link>
                        <p className="text-sm text-muted-foreground">
                            Master English fluency with the power of AI. Real-time feedback, personalized coaching, and limitless practice.
                        </p>
                    </div>
                    <div>
                ...
                <div className="mt-12 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-sm text-muted-foreground text-center md:text-left">
                        &copy; {new Date().getFullYear()} SpokenEdge. All rights reserved.
                    </p>
